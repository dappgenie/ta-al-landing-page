    ...
    >
      ...
      <div className='relative z-20 mt-20 lg:mt-0'>
        <Image
          ...
          priority
        />
        <PaymentCredited className='absolute -top-10 left-[5%] lg:-top-7 lg:left-[-7%] 2xl:left-[5%]' />
        <TotalIncome className='absolute -bottom-10 md:bottom-4 left-[10%] lg:-right-[20%]' />
        <IconCont className='bg-[#4535AF] absolute top-[30%] left-[10%] lg:left-[7%] xl:left-[15%] -rotate-[20deg]'>
          <CheckIcon className='w-[20px] h-auto text-white' />
        </IconCont>
        <IconCont className='bg-[#FBC75E] absolute top-[30%] right-[10%] lg:right-[2%] rotate-[20deg]'>
