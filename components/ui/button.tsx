...
const buttonVariants = cva(
  'inline-flex cursor-pointer items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'bg-primary text-primary-foreground hover:bg-primary/90 hover:drop-shadow-[0_0px_5px_rgb(126 204 172)]',
        destructive:
          'bg-destructive text-destructive-foreground hover:bg-destructive/90',
        outline:
          'border border-input bg-background hover:bg-accent hover:text-accent-foreground',
        secondary:
          'bg-[#2F0032]/50 text-secondary-foreground border border-border hover:bg-border/80 hover:border-primary',
        ghost: 'hover:bg-accent hover:text-accent-foreground',
        footer: 'text-primary underline-offset-4 bg-white hover:bg-white/80',
